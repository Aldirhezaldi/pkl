...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Kegiatan User Instansi</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-12">
                                                ...
                                                <form class="" method="post" action="<?= base_url(); ?>kegiatan/tambahkegiatanadmin">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:center;">
                                                                        <?= date("H:i", strtotime($row['tanggal_kegiatan'])); ?>
                                                                    </td>
                                                                    <!-- <td style="text-align:center;">
                                                                        <?php $datenumber = substr($row['tanggal_kegiatan'], 5, 2); ?>
                                                                        <?= $datenumber; ?>
                                                                    </td> -->
                                                                    ...
                                                                    <!-- <td>
                                                                        <a class="btn btn-danger" style="color: #ffffff; margin-top: 8px;" onclick="getAlert(<?= $row['id_kegiatan']; ?>)">
                                                                            Delete</a>
                                                                        <script>
                                                                                    ...
                                                                                    .then((willDelete) => {
                                                                                        if (willDelete) {
                                                                                            swal({
                                                                                                ...
                                                                                                window.location.href = `<?= base_url(); ?>kegiatan/hapusdatakegiatanuser/${id}`;
                                                                                            })
                                                                                        } else {
                                                                                            swal({
                                                                                                title: "Alert",
                                                                        ...
                                                                        <a class="btn btn-warning" style="color: #ffffff; margin-top: 8px;" href="<?= base_url(); ?>kegiatan/editdatakegiatanuser/<?= $row['id_kegiatan']; ?>">
                                                                            Edit</a>
                                                                    </td> -->
                                                                </tr>
                                                            <?php
                                                ...
                                                <a href="<?= base_url(); ?>kegiatan/kegiatanadmin" class="btn btn-primary float-right">Kembali</a>
                                            </div>
                                        </div>
