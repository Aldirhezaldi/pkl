...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Daftar Kegiatan User</title>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-12">
                                                <header style="border-bottom: 2px solid lightblue;">
                                                    <h1 style="display: inline-block; margin-left: 300px; font-weight: bold; color:steelblue;">Rekap Kegiatan Agustus 2021</h1>
                                                </header>
