...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Daftar Kegiatan</title>
                                            ...
                                            <div class="col-xl-12">
                                                <header style="border-bottom: 2px solid lightblue;">
                                                    <a class="btn btn-info" style="color: #ffffff; margin-bottom: 10px;" href="<?= base_url(); ?>kegiatan/tambahdatakegiatanuser">
                                                        Tambah</a>
                                                    <h1 style="display: inline-block; margin-left: 330px; font-weight: bold; color:steelblue;">Kegiatan</h1>
                                                </header>
                                                <form class="" method="post" action="<?= base_url(); ?>kegiatan/tambahkegiatanuser">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:center;"><?= $_SESSION['nama'] ?></td>
