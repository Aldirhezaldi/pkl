...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Tambah Data Kegiatan User</title>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Tambah Kegiatan</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>kegiatan/tambahdatakegiatanuser">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="tanggal_kegiatan">Pukul Kegiatan</label>
                                                                        <p class="form-control"><?= date("H:i", strtotime($now)); ?></p>
                                                                        <input type="hidden" class="form-control" id="tanggal_kegiatan" name="tanggal_kegiatan" value="<?= $now ?>">
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="deskripsi_kegiatan">Deskripsi Kegiatan</label>
                                                                        <br>
                                                                        <textarea rows="4" cols="60" class="form-control" id="deskripsi_kegiatan" name="deskripsi_kegiatan" placeholder="Enter Deskripsi Kegiatan"></textarea>
                                                                    </div>
                                                        ...
                                                        <a href="<?= base_url(); ?>kegiatan/kegiatanuser" class="btn btn-info float-right">Kembali</a>
                                                    </div>
                                                </div>
                                                <div class="col-2"></div>
                                            </div>
