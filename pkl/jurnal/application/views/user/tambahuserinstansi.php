                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="px-2 py-3">
                                    ...
                                    <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?= base_url(); ?>user/tambahuserinstansi">

                                        <div class="mb-3">
                                            <label for="email">Email Akun Admin</label>
                                            <input type="email" class="form-control" id="email" name="email" placeholder="Enter Email Akun Admin">
                                        </div>

                                        <div class="mb-3">
                                            <label for="password">Password Akun Admin</label>
                                            <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password Akun Admin">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="namauser" name="namauser" placeholder="Enter Nama Admin">
                                        </div>

                                        <div class="mb-3">
                                            <label for="alamat">Alamat Admin</label>
                                            <textarea rows="3" cols="60" class="form-control" id="alamat" name="alamat" placeholder="Enter Alamat Admin"></textarea>
                                        </div>
