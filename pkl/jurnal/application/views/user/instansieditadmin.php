...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Edit Data Instansi</title>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Ubah Instansi</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>instansi/editdata/<?= $instansi['id_instansi']; ?>">
                                                                    <input type="hidden" id="id_instansi" name="id_instansi" value="<?= $instansi['id_instansi']; ?>">
                                                                    <div class="mb-3">
                                                                        <label for="namainstansi">Nama Instansi</label>
                                                                        <input type="text" class="form-control" id="namainstansi" name="namainstansi" value="<?= $instansi['nama_instansi']; ?>" placeholder="Enter Nama Instansi">
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="alamat">Alamat</label>
                                                                        <input type="text" class="form-control" id="alamat" name="alamat" value="<?= $instansi['alamat']; ?>" placeholder="Enter Alamat">
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="deskripsiinstansi">Deskripsi</label>
                                                                        <br>
                                                                        <textarea rows="5" cols="60" class="form-control" id="deskripsiinstansi" name="deskripsiinstansi" value="<?= $instansi['deskripsi_instansi']; ?>" placeholder="Enter Deskripsi Instansi"><?= $instansi['deskripsi_instansi']; ?></textarea>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="email">Email</label>
                                                                        <input type="email" class="form-control" id="email" name="email" value="<?= $instansi['email']; ?>" placeholder="Enter Email">
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="telp">Telepon</label>
                                                                        <input type="text" class="form-control" id="telp" name="telp" value="<?= $instansi['telp']; ?>" placeholder="Enter Telepon">
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="telp">Logo Lama</label><br>
                                                                        <img src="data:<?= $instansi['tipe_logo']; ?>;base64,<?= $instansi['logo']; ?>" alt="logo" style="width: 100px; height: 100px;" />
                                                                    </div>
                                                        ...
                                                        <a href="<?= base_url(); ?>instansi" class="btn btn-info float-right">Kembali</a>
                                                    </div>
                                                </div>
                                                <div class="col-2"></div>
                                            </div>
