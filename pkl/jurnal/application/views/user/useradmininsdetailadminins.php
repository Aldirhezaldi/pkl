...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Detail Data Admin Instansi</title>
                                            ...
                                            <div class="col-xl-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-8 text-white">
                                                                ...
                                                                <table class="table table-success">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <img src="data:<?= $instansi['tipe_logo']; ?>;base64,<?= $instansi['logo']; ?>" width="100" height="100">
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                        ...
                                                        <a href="<?= base_url(); ?>user/useradmininsadminins" class="btn btn-primary float-right">Kembali</a>
                                                    </div>
                                                    <div class="col-2"></div>
                                                </div>
                                            </div>
