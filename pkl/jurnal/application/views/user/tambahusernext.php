                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="px-2 py-3">
                                    ...
                                    <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?= base_url(); ?>user/tambahusernextinsert">
                                        ...
                                        <div class="mb-3">
                                            <label for="namadivisi">Pilih Nama Divisi</label>
