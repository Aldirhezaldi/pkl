...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Form Tambah Instansi</title>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Tambah Instansi</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>instansi/tambahdata">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="file" name="logo" class="form-control" onchange="PreviewImage();" id="logo"><br>
                                                        ...
                                                        <a href="<?= base_url(); ?>instansi" class="btn btn-info float-right">Back</a>
                                                    </div>
                                                </div>
                                                <div class="col-2"></div>
                                            </div>
