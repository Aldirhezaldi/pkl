...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Edit Data Admin Instansi</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Form Ubah Data Admin Instansi</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Ubah Admin Instansi</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <?php foreach ($user as $row) : ?>
                                                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/editdataadmininsadmin/<?= $row->id_user; ?>">
                                                                        <input type="hidden" id="id_user" name="id_user" value="<?= $row->id_user; ?>">
                                                                        <div class="mb-3">
                                                                            <label for="email">Email</label>
                                                                            <input type="text" class="form-control" id="email" name="email" value="<?= $row->email; ?>" placeholder="Enter Email">
                                                                        </div>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control" id="nip" name="nip" value="<?= $row->nip; ?>" placeholder="Enter NIP">
                                                                        </div>

                                                                        <div class="mb-3">
                                                                            <label for="nama_user">Nama</label>
                                                                            <input type="text" class="form-control" id="nama_user" name="nama_user" value="<?= $row->nama_user; ?>" placeholder="Enter Nama">
                                                                        </div>

                                                                        <div class="mb-3">
                                                                            <label for="alamat">Alamat</label>
                                                                            <br>
                                                                            <textarea rows="3" cols="60" class="form-control" id="alamat" name="alamat" value="<?= $row->alamat; ?>" placeholder="Enter Alamat"><?= $row->alamat; ?></textarea>
                                                                        </div>

                                                                        <div class="mb-3">
                                                                            <label for="tanggal_registrasi">Tanggal Registrasi</label>
                                                                            <input type="date" class="form-control" id="tanggal_registrasi" name="tanggal_registrasi" value="<?= $row->tanggal_registrasi; ?>" placeholder="Enter Tanggal Registrasi">
                                                                        </div>

                                                                        
                                                                        <div class="mb-3">
                                                                            <label for="foto">Foto Lama</label><br>
                                                                            <img src="data:<?= $row->tipe_foto; ?>;base64,<?= $row->foto; ?>" alt="foto" style="width: 100px; height: 100px;" />
                                                                        </div>
                                                        ...
                                                        <a href="<?= base_url(); ?>user/useradmininstansiadmin" class="btn btn-info float-right">Kembali</a>
                                                    </div>
                                                </div>
                                                <div class="col-2"></div>
                                            </div>
