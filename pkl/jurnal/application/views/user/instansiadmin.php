...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Datfar Instansi</title>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-12">
                                                <header style="border-bottom: 2px solid lightblue;">
                                                    <a class="btn btn-info" style="color: #ffffff; margin-bottom: 10px;" href="<?= base_url(); ?>instansi/tambahdata">
                                                        Tambah</a>
                                                    <h1 style="display: inline-block; margin-left: 360px; font-weight: bold; color:steelblue;">Instansi</h1>
                                                </header>
                                                <form class="" method="post" action="<?= base_url(); ?>user/tambah">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= $row->email; ?></td>
                                                                    <td><?= $row->telp; ?></td>
                                                                    <td><img src="data:<?= $row->tipe_logo; ?>;base64,<?= $row->logo; ?>" width="80" height="80"></td>
                                                                    <td><?= $row->status; ?></td>
                                                                    <td><a class="btn btn-success" style="color: #ffffff" href="<?= base_url(); ?>instansi/editstatus/<?= $row->id_instansi; ?>">
                                                                            Ubah Status</a><br>
                                                                        <a class="btn btn-danger" style="color: #ffffff; margin-top: 8px;" onclick="getAlert(<?= $row->id_instansi; ?>)">
                                                                            Hapus</a><br>
                                                                        <script>
                                                                                    ...
                                                                                    .then((willDelete) => {
                                                                                        if (willDelete) {
                                                                                            swal({
                                                                                                ...
                                                                                                window.location.href = `<?= base_url(); ?>instansi/hapusdata/${id}`;
                                                                                            })
                                                                                        } else {
                                                                                            swal({
                                                                                                title: "Alert",
                                                                        ...
                                                                        <a class="btn btn-warning" style="color: #ffffff; margin-top: 8px;" href="<?= base_url(); ?>instansi/editdata/<?= $row->id_instansi; ?>">
                                                                            Ubah</a>
                                                                    </td>
                                                                </tr>
                                                            <?php
