                                            ...
                                            <div class="col-xl-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <?php foreach ($user as $row) : ?>
                                                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/editdatauseradmin/<?= $row->id_user; ?>">
                                                        ...
                                                        <a href="<?= base_url(); ?>user/user" class="btn btn-info float-right">Kembali</a>
                                                    </div>
                                                </div>
                                                <div class="col-2"></div>
                                            </div>
