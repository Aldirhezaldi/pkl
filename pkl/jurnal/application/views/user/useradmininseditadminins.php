                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Edit Data Admin Instansi</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="col-xl-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <?php foreach ($user as $row) : ?>
                                                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/editdataadmininsadminins/<?= $row->id_user; ?>">
                                                        ...
                                                        <a href="<?= base_url(); ?>user/useradmininsadminins" class="btn btn-info float-right">Kembali</a>
                                                    </div>
                                                </div>
                                                <div class="col-2"></div>
                                            </div>
