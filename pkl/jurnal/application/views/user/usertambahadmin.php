...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Tambah Super Admin</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Form Tambah Data Super Admin</h4>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Tambah Super Admin</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/tambahdataadmin">
