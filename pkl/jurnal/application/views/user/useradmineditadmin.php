...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Edit Data Super Admin</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Form Edit Data Super Admin</h4>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Ubah Super Admin</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <?php foreach ($user as $row) : ?>
                                                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/editdataadmin/<?= $row->id_user; ?>">
                                                        ...
                                                        <a href="<?= base_url(); ?>user/useradmin" class="btn btn-info float-right">Kembali</a>
                                                    </div>
                                                </div>
                                                <div class="col-2"></div>
                                            </div>
