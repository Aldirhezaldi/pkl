                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/tambahdataadmininsadmininsnextinsert">
                                        ...
                                        <script>
                                            function getAlert() {
                                                swal({
                                                    ...
                                                    window.location.href = `<?= base_url(); ?>user/useradmininsadminins`;
                                                });
                                            }
                                        </script>

                                        <?php
                                        if (!empty($tambah_admin_ins_admin_ins_next)) { ?>
                                            <script>
                                                getAlert();
                                            </script>
                                        <?php } ?>
