                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-12">
                                                <header style="border-bottom: 2px solid lightblue;">
                                                    <h1 style="display: inline-block; margin-left: 455px; font-weight: bold; color:steelblue;">User</h1>
                                                </header>
                                                <form class="" method="post" action="<?= base_url(); ?>user/tambahuseruser">
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                                    ...
                                                                                    .then((willDelete) => {
                                                                                        if (willDelete) {
                                                                                            swal({
                                                                                                ...
                                                                                                window.location.href = `<?= base_url(); ?>user/hapusdatauseruser/${id}`;
                                                                                            })
                                                                                        } else {
                                                                                            swal({
                                                                                                title: "Alert",
                                                                        ...
                                                                        <a class="btn btn-warning" style="color: #ffffff; margin-top: 8px;" href="<?= base_url(); ?>user/editdatauseruser/<?= $row->id_user; ?>">
                                                                            Ubah</a><br>
                                                                        <a class="btn btn-primary" style="color: #ffffff; margin-top: 8px;" href="<?= base_url(); ?>user/detaildatauseruser/<?= $row->id_user; ?>">
                                                                            Detil</a>
                                                                    </td>
                                                                </tr>
                                                            <?php
