                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-12">
                                                <header style="border-bottom: 2px solid lightblue;">
                                                    <a class="btn btn-info" style="color: #ffffff; margin-bottom: 10px;" href="<?= base_url(); ?>user/tambahdataadmininsadminins">
                                                        Tambah</a>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= $row->level; ?></td>
                                                                    <td><?= $row->status; ?></td>
                                                                    <td><a class="btn btn-success" style="color: #ffffff" href="<?= base_url(); ?>user/editstatusadmininsadminins/<?= $row->id_user; ?>">
                                                                            Ubah Status</a><br>
                                                                                    ...
                                                                                    .then((willDelete) => {
                                                                                        if (willDelete) {
                                                                                            swal({
                                                                                                ...
                                                                                                window.location.href = `<?= base_url(); ?>user/hapusdataadmininsadminins/${id}`;
                                                                                            })
                                                                                        } else {
                                                                                            swal({
                                                                                                title: "Alert",
                                                                        ...
                                                                        <a class="btn btn-warning" style="color: #ffffff; margin-top: 8px;" href="<?= base_url(); ?>user/editdataadmininsadminins/<?= $row->id_user; ?>">
                                                                            Ubah</a><br>
                                                                        <a class="btn btn-primary" style="color: #ffffff; margin-top: 8px;" href="<?= base_url(); ?>user/detaildataadmininsadminins/<?= $row->id_user; ?>">
                                                                            Detil</a>
                                                                    </td>
                                                                </tr>
                                                            <?php
