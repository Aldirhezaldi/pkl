...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard Admin Instansi</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Dashboard Admin Instansi</h4>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h1>Selamat Datang Admin Instansi:</h1>
                                        <h3 style="color: blue;"><?= $_SESSION['nama']; ?></h3><br>
                                        <h1>Anda berasal dari Instansi:</h1>
                                        <h3 style="color: blue;"><?= $_SESSION['nama_instansi']; ?></h3>
