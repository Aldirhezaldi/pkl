...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Datar Super Admin</title>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-12">
                                                <header style="border-bottom: 2px solid lightblue;">
                                                    <a class="btn btn-info" style="color: #ffffff; margin-bottom: 10px;" href="<?= base_url(); ?>user/tambahdataadmin">
                                                        Tambah</a>
                                                    <h1 style="display: inline-block; margin-left: 330px; font-weight: bold; color:steelblue;">Super Admin</h1>
                                                </header>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= $row->level; ?></td>
                                                                    <td><?= $row->status; ?></td>
                                                                    <td><a class="btn btn-success" style="color: #ffffff" href="<?= base_url(); ?>user/editstatusadmin/<?= $row->id_user; ?>">
                                                                            Ubah Status</a><br>
                                                                                    ...
                                                                                    .then((willDelete) => {
                                                                                        if (willDelete) {
                                                                                            swal({
                                                                                                ...
                                                                                                window.location.href = `<?= base_url(); ?>user/hapusdataadmin/${id}`;
                                                                                            })
                                                                                        } else {
                                                                                            swal({
                                                                                                title: "Alert",
                                                                        ...
                                                                        <a class="btn btn-warning" style="color: #ffffff; margin-top: 8px;" href="<?= base_url(); ?>user/editdataadmin/<?= $row->id_user; ?>">
                                                                            Ubah</a>
                                                                    </td>
                                                                </tr>
                                                            <?php
