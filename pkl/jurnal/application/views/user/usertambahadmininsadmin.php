                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Form Tambah Data Admin Instansi</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/tambahdataadmininsadmin">
                                        ...
                                        <script>
                                            function getAlert() {
                                                swal({
                                                    ...
                                                    window.location.href = `<?= base_url(); ?>user/tambahdataadmininsadminnext`;
                                                });
                                            }
                                        </script>
                                        ...
                                        <?php
                                        if (!empty($tambah_admin_ins_admin)) { ?>
                                            <script>
                                                getAlert();
                                            </script>
                                        <?php } ?>
