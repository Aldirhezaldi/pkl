...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Tambah Data Admin Instansi</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Tambah Data Admin Instansi</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Tambah Admin Instansi</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/tambahdataadmininsadminins">
                                        ...
                                        <script>
                                            function getAlert() {
                                                swal({
                                                    ...
                                                    window.location.href = `<?= base_url(); ?>user/tambahdataadmininsadmininsnext`;
                                                });
                                            }
                                        </script>
                                        ...
                                        <?php
                                        if (!empty($tambah_admin_ins_admin_ins)) { ?>
                                            <script>
                                                getAlert();
                                            </script>
                                        <?php } ?>
