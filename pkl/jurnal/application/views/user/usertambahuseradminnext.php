                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/tambahdatauseradminnextinsert">
                                        ...
                                        <?php
                                        if (!empty($tambah_user_admin_next)) { ?>
                                            <script>
                                                getAlert();
                                            </script>
                                        <?php } ?>
