                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-12">
                                                <header style="border-bottom: 2px solid lightblue;">
                                                    <a class="btn btn-info" style="color: #ffffff; margin-bottom: 10px;" href="<?= base_url(); ?>user/tambahdatauseradmin">
                                                        Tambah</a>
                                                    <h1 style="display: inline-block; margin-left: 380px; font-weight: bold; color:steelblue;">User</h1>
                                                </header>
                                                <form class="" method="post" action="<?= base_url(); ?>user/tambahuseradmin">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?= $row->level; ?></td>
                                                                    <td><?= $row->status; ?></td>
                                                                    <td><a class="btn btn-success" style="color: #ffffff" href="<?= base_url(); ?>user/editstatususeradmin/<?= $row->id_user; ?>">
                                                                            Ubah Status</a><br>
                                                                                    ...
                                                                                    .then((willDelete) => {
                                                                                        if (willDelete) {
                                                                                            swal({
                                                                                                ...
                                                                                                window.location.href = `<?= base_url(); ?>user/hapusdatauseradmin/${id}`;
                                                                                            })
                                                                                        } else {
                                                                                            swal({
                                                                                                title: "Alert",
                                                                        ...
                                                                        <a class="btn btn-warning" style="color: #ffffff; margin-top: 8px;" href="<?= base_url(); ?>user/editdatauseradmin/<?= $row->id_user; ?>">
                                                                            Ubah</a><br>
                                                                        <a class="btn btn-primary" style="color: #ffffff; margin-top: 8px;" href="<?= base_url(); ?>user/detaildatauseradmin/<?= $row->id_user; ?>">
                                                                            Detil</a>
                                                                    </td>
                                                                </tr>
                                                            <?php
