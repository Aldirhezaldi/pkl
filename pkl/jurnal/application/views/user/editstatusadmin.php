...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Edit Staus Super Admin</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Form Edit Status Super Admin</h4>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Ubah Status Super Admin</center>
                                                            </div>
                                                            <div class="card-body">
                                                        ...
                                                        <a href="<?= base_url(); ?>user/useradmin" class="btn btn-primary float-right">Kembali</a>
                                                    </div>
                                                    <div class="col-2"></div>
                                                </div>
                                            </div>
