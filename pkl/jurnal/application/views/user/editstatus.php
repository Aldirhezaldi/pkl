...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Edit Status Instansi</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Form Edit Status Instansi</h4>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Ubah Status Instansi</center>
                                                            </div>
                                                            <div class="card-body">
                                                                    ...
                                                                    <table class="table table-success">
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <img src="data:<?= $instansi['tipe_logo']; ?>;base64,<?= $instansi['logo']; ?>" width="80" height="80">
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <th>
                                                        ...
                                                        <a href="<?= base_url(); ?>instansi" class="btn btn-primary float-right">Kembali</a>
                                                    </div>
                                                    <div class="col-2"></div>
                                                </div>
                                            </div>
