...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Detail Data User</title>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Detail Data User</center>
                                                            </div>
                                                            <div class="card-body">
                                                        ...
                                                        <a href="<?= base_url(); ?>user/useruser" class="btn btn-primary float-right">Kembali</a>
                                                    </div>
                                                    <div class="col-2"></div>
                                                </div>
                                            </div>
