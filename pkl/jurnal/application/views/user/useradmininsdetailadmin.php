...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Detail Admin Instansi</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Detail Data Admin Instansi</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Detail Data Admin Instansi</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <table class="table table-success">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <!-- <?= var_dump($user) ?><br>
                                                                                    <?= var_dump($user_instansi_detail) ?><br> -->
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <img src="data:<?= $user[0]->tipe_foto; ?>;base64,<?= $user[0]->foto; ?>" alt="foto" style="width: 100px; height: 100px;" />
                                                                            </td>
                                                                        </tr>
                                                                        <th>
                                                                            Asal Instansi
                                                                        ...
                                                                        <td>
                                                                            <?= $user_instansi_detail['nama_instansi']; ?>
                                                                        </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <img src="data:<?= $user_instansi_detail['tipe_logo']; ?>;base64,<?= $user_instansi_detail['logo']; ?>" width="100" height="100">
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                        ...
                                                        <a href="<?= base_url(); ?>user/useradmininstansiadmin" class="btn btn-primary float-right">Kembali</a>
                                                    </div>
                                                    <div class="col-2"></div>
                                                </div>
                                            </div>
