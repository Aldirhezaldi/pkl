...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Edit Data Pengumuman</title>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Ubah Pengumuman</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <?php foreach ($pengumuman as $row) : ?>
                                                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>pengumuman/editdatapengumumanadminins/<?= $row['id_pengumuman']; ?>">
                                                                        <input type="hidden" id="id_pengumuman" name="id_pengumuman" value="<?= $row['id_pengumuman']; ?>">
                                                                        <div class="mb-3">
                                                                            <label for="judul">Judul</label>
                                                                            <input type="text" class="form-control" id="judul" name="judul" value="<?= $row['judul']; ?>" placeholder="Enter Judul Pengumuman">
                                                                        </div>

                                                                        <div class="mb-3">
                                                                            <label for="isi">Isi</label>
                                                                            <br>
                                                                            <textarea rows="4" cols="60" class="form-control" id="isi" name="isi" value="<?= $row['isi']; ?>" placeholder="Enter Isi Pengumuman"><?= $row['isi']; ?></textarea>
                                                                        </div>
                                                        ...
                                                        <script>
                                                            function getAlert() {
                                                                swal({
                                                                    ...
                                                                    text: "Data pengumuman telah diedit",
                                                                    icon: "success",
                                                                    closeOnClickOutside: false,
                                                                }).then(() => {
                                                        ...
                                                        <?php
                                                        if (!empty($edit_pengumuman_adminins)) { ?>
                                                            <script>
                                                                getAlert();
                                                            </script>
                                                        <?php } ?>
