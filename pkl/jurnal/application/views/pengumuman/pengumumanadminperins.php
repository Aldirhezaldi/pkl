...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Daftar Pengumuman User Instansi</title>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <div class="page-title">
                                    <h4>Daftar Pengumuman User Instansi</h4>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-12">
                                                ...
                                                <form class="" method="post" action="<?= base_url(); ?>pengumuman/tambahpengumumanadmin">
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a class="btn btn-success" style="color: #ffffff; margin-top: 8px;" onclick="getDetail(`<?= $row['judul']; ?>`, `<?= $row['isi']; ?>`, `<?= $row['foto']; ?>`, `<?= $row['tipe_foto']; ?>`)">
                                                                            Detil</a>
                                                                    </td>
                                                                </tr>
                                                            <?php
                                                ...
                                                <a href="<?= base_url(); ?>pengumuman/pengumumanadmin" class="btn btn-primary float-right">Kembali</a>
                                            </div>
                                        </div>
