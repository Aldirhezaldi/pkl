                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Tambah Pengumuman</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>pengumuman/tambahdatapengumumanadminins">

                                                                    <div class="mb-3">
                                                                        <label for="tanggal_pengumuman">Tanggal Pengumuman</label>
                                                                        <?php date_default_timezone_set('Asia/Jakarta'); # add your city to set local time zone
                                                                        $now = date('Y-m-d H:i:s'); ?>
                                                                        <p class="form-control"><?= date("d-m-Y", strtotime($now)); ?></p>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="tanggal_pengumuman">Pukul Pengumuman</label>
                                                                        <p class="form-control"><?= date("H:i", strtotime($now)); ?></p>
                                                                        <input type="hidden" class="form-control" id="tanggal_pengumuman" name="tanggal_pengumuman" value="<?= $now ?>">
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="judul">Judul</label>
                                                                        <input type="text" class="form-control" id="judul" name="judul" placeholder="Enter Judul Pengumuman">
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="isi">Isi</label>
                                                                        <br>
                                                                        <textarea rows="4" cols="60" class="form-control" id="isi" name="isi" placeholder="Enter Isi Pengumuman"></textarea>
                                                                    </div>
                                                        ...
                                                        <a href="<?= base_url(); ?>pengumuman/pengumumanadminins" class="btn btn-info float-right">Kembali</a>
                                                    </div>
                                                </div>
                                                <div class="col-2"></div>
                                            </div>
                                        ...
                                        <script>
                                            function getAlert() {
                                                swal({
                                                    ...
                                                    window.location.href = `<?= base_url(); ?>pengumuman/pengumumanadminins`;
                                                });
                                            }
                                        </script>
                                        ...
                                        <?php
                                        if (!empty($tambah_pengumuman_adminins)) { ?>
                                            <script>
                                                getAlert();
                                            </script>
                                        <?php } ?>
