...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Tambah Data Divisi</title>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Tambah Divisi</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>divisi/tambahdatadivisiadminins">
                                                                    <div class="mb-3">
                                                                        <label for="nama_instansi">Asal Instansi</label>
                                                                        <p class="form-control"><?= $_SESSION['nama_instansi']; ?></p>
                                                                        <input type="hidden" class="form-control" id="id_instansi" name="id_instansi" value="<?= $_SESSION['id_instansi']; ?>">
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="nama_divisi">Divisi</label>
                                                                        <input type="text" class="form-control" id="nama_divisi" name="nama_divisi" placeholder="Enter Divisi">
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="deskripsi_divisi">Deskripsi</label>
                                                                        <br>
                                                                        <textarea rows="4" cols="60" class="form-control" id="deskripsi_divisi" name="deskripsi_divisi" placeholder="Enter Deskripsi"></textarea>
                                                                    </div>

                                                                    <div class="mb-3">
                                                                        <label for="telp_divisi">Telp</label>
                                                                        <input type="text" class="form-control" id="telp_divisi" name="telp_divisi" placeholder="Enter Telp">
                                                                    </div>
                                                                    <div class="mt-4">
                                        ...
                                        <script>
                                            function getAlert() {
                                                swal({
                                                    ...
                                                    text: "Data telah terinput dalam system",
                                                    icon: "success",
                                                    closeOnClickOutside: false,
                                                }).then(() => {
                                        ...
                                        <?php
                                        if (!empty($tambah_divisi_adminins)) { ?>
                                            <script>
                                                getAlert();
                                            </script>
                                        <?php } ?>
