...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Edit Divisi</title>
                                                    ...
                                                    <div class="col-8 text-white">
                                                        <div class="card bg-secondary">
                                                            <div class="card-header bg-dark">
                                                                <center>Form Ubah Divisi</center>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                <?php foreach ($divisi as $row) : ?>
                                                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>divisi/editdatadivisiadminins/<?= $row['id_divisi']; ?>">
                                                                        <input type="hidden" id="id_divisi" name="id_divisi" value="<?= $row['id_divisi']; ?>">
                                                                        <div class="mb-3">
                                                                            <label for="nama_instansi">Asal Instansi</label>
                                                                            <p class="form-control"><?= $_SESSION['nama_instansi']; ?></p>
                                                                        </div>

                                                                        <div class="mb-3">
                                                                            <label for="nama_divisi">Divisi</label>
                                                                            <input type="text" class="form-control" id="nama_divisi" name="nama_divisi" value="<?= $row['nama_divisi']; ?>" placeholder="Enter Divisi">
                                                                        </div>

                                                                        <div class="mb-3">
                                                                            <label for="deskripsi_divisi">Deskripsi</label>
                                                                            <br>
                                                                            <textarea rows="4" cols="60" class="form-control" id="deskripsi_divisi" name="deskripsi_divisi" value="<?= $row['deskripsi_divisi']; ?>" placeholder="Enter Deskripsi"><?= $row['deskripsi_divisi']; ?></textarea>
                                                                        </div>

                                                                        <div class="mb-3">
                                                                            <label for="telp_divisi">Telp</label>
                                                                            <input type="text" class="form-control" id="telp_divisi" name="telp_divisi" value="<?= $row['telp_divisi']; ?>" placeholder="Enter Telp">
                                                                        </div>
                                                                        <div class="mt-4">
                                                        ...
                                                        <a href="<?= base_url(); ?>divisi/divisiadminins" class="btn btn-info float-right">Kembali</a>

                                                        <script>
                                                            function getAlert() {
                                                                swal({
                                                                    title: "Divisi Berhasil Diedit",
                                                                    text: "Data divisi telah diedit",
                                                                    icon: "success",
                                                                    closeOnClickOutside: false,
                                                                }).then(() => {
                                                                    window.location.href = `<?= base_url(); ?>divisi/divisiadminins`;
                                                                });
                                                            }
                                                        </script>
