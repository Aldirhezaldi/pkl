...
<head>
    ...
    <meta charset="utf-8" />
    <title>Halaman Daftar Divisi</title>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-12">
                                                <header style="border-bottom: 2px solid lightblue;">
                                                    <a class="btn btn-info" style="color: #ffffff; margin-bottom: 10px;" href="<?= base_url(); ?>divisi/tambahdatadivisiadminins">
                                                        Tambah</a>
                                                    <h1 style="display: inline-block; margin-left: 375px; font-weight: bold; color:steelblue;">Divisi</h1>
                                                </header>
                                                <form class="" method="post" action="<?= base_url(); ?>divisi/tambahdivisiadminins">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:center;">
                                                                        <?= $row['deskripsi_divisi'] ?>
                                                                    </td>
                                                                    <td style="text-align:center;">
                                                                        <?= $row['telp_divisi'] ?>
                                                                    </td>
                                                                    <td>
                                                                        <a class="btn btn-danger" style="color: #ffffff; margin-top: 8px;" onclick="getAlert(<?= $row['id_divisi']; ?>)">
                                                                            Hapus</a><br>
                                                                        <script>
                                                                                    ...
                                                                                    .then((willDelete) => {
                                                                                        if (willDelete) {
                                                                                            swal({
                                                                                                ...
                                                                                                window.location.href = `<?= base_url(); ?>divisi/hapusdatadivisiadminins/${id}`;
                                                                                            })
                                                                                        } else {
                                                                                            swal({
                                                                                                title: "Alert",
                                                                        ...
                                                                        <a class="btn btn-warning" style="color: #ffffff; margin-top: 8px;" href="<?= base_url(); ?>divisi/editdatadivisiadminins/<?= $row['id_divisi']; ?>">
                                                                            Ubah</a>
                                                                    </td>
                                                                </tr>
                                                            <?php
