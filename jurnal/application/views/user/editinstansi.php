                ...
                <div class="page-content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
                                    ...
                                    <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>instansi/updateinstansi">
    
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="header-title">Edit Data Instansi</h4>
                                            <p class="card-title-desc">Mengedit Data Instansi.</p>
                                            

                                            <div class="mb-3">
                                            <?php foreach($instansi as $i){ ?>
                                            <label for="namainstansi">Nama Instansi</label>
                                            <input type="hidden" name="id_instansi" id="id_instansi" aria-describedby="emailHelp" value="<?php echo $i->id_instansi ?>">
                                            <input type="text" class="form-control" id="nama_instansi" name="nama_instansi" value="<?php echo $i->nama_instansi ?>">
                                        </div>

                                        <div class="mb-3">
                                            <label for="alamat">Alamat</label>
                                            <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $i->alamat ?>">
                                        </div>

                                        <div class="mb-3">
                                            <label for="deskripsiinstansi">Deskripsi</label>
                                            <br>
                                            <textarea rows="5" cols="60" class="form-control" id="deskripsi_instansi" name="deskripsi_instansi"><?php echo $i->deskripsi_instansi ?></textarea>
                                        </div>

                                        <div class="mb-3">
                                            <label for="email">Email</label>
                                            <input type="email" class="form-control" id="email" name="email" value="<?php echo $i->email ?>">
                                        </div>

                                        <div class="mb-3">
                                            <label for="telp">Telepon</label>
                                            <input type="text" class="form-control" id="telp" name="telp" value="<?php echo $i->telp ?>">
                                        </div>
