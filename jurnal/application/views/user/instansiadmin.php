                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-12">
                                                ...
                                                <a type="button" href="<?= base_url(); ?>instansi/tambahinstansi" class="btn btn-primary">Tambah</a>
                                                <form class="" method="post" action="<?= base_url(); ?>user/tambah">
                                                    <table class="table table-bordered table-hover table-info" style="text-align:justify;">
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><a class="btn btn-success" style="color: #ffffff" href="<?= base_url(); ?>instansi/editstatus/<?= $row->id_instansi; ?>">
                                                                            Edit Status</a>
                                                                            <a class="btn btn-warning" style="color: #ffffff" href="<?= base_url(); ?>instansi/editinstansi/<?= $row->id_instansi; ?>">
                                                                            Edit</a>
                                                                            <a type="button" class="btn btn-danger" href="<?= base_url(); ?>instansi/hapus/<?= $row->id_instansi; ?>">Hapus</a></td>
                                                                </tr>
                                                            <?php
                                                            }
                                                            ?>
