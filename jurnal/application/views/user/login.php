                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="mt-5 text-center text-white">
                            <p>
                                Don't have an account ?<a href="<?= base_url(); ?>user" class="fw-bold text-white">
                                    Register User</a>
                            </p>
                            <p>
                                Don't have an instansi account ?<a href="<?= base_url(); ?>instansi/tambah" class="fw-bold text-white">
                                    Register Instansi</a>
                            </p>
                            <p>
                                ©
